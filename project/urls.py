...
from project.apps.drf.views import CategoryViewSet
from project.apps.drf.views import IngredientViewSet
from project.apps.gqyl.schema import schema
from project.apps.gqyl.views import DRFAuthenticatedGraphQLView
